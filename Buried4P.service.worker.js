...
/** @type {string} */
const CACHE_VERSION = '1783462683|92943929';
/** @type {string} */
const CACHE_PREFIX = 'Buried-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Buried4P.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Buried4P.html","Buried4P.js","Buried4P.offline.html","Buried4P.icon.png","Buried4P.apple-touch-icon.png","Buried4P.audio.worklet.js","Buried4P.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Buried4P.wasm","Buried4P.pck"];
